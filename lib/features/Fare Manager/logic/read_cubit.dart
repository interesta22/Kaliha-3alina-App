  ...
  void getRides() {
    ...
    try {
      final List<RideModel> ridesList =
          _hiveBox
              .get(HiveConstants.ridesList, defaultValue: <RideModel>[])
              ?.cast<RideModel>()
              .toList() ??
          [];
    ...
    switch (vehicleFilter) {
      ...
      case VehicleFilter.microbusOnly:
        ridesList.removeWhere(
          (ride) => ride.vehicleType != VehicleType.microbus,
        );
      ...
      case VehicleFilter.otherOnly:
        ridesList.removeWhere(
          (ride) =>
              ride.vehicleType == VehicleType.microbus ||
              ride.vehicleType == VehicleType.suzuki,
        );
    }
  }
}
