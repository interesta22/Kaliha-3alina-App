...
import 'package:khaliha_3alina/features/Fare%20Manager/presentation/widgets/suzuki_show_rider_model.dart';
...
class _SuzukiViewState extends State<SuzukiView> {
  ...
  Future<void> _addRider() async {
    final rider = await showSuzukiAddRiderModal(context, individualFare);
    if (rider != null) {
